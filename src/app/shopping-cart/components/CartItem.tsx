  ...
  return (
    <div className="flex flex-col gap-4 border-b border-border pb-6 transition-luxury hover:bg-muted/30 sm:flex-row sm:items-center sm:gap-6 sm:pb-8">
      ...
      <div className="flex flex-1 flex-col gap-2">
        <h3 className="font-heading text-lg font-medium text-text-primary sm:text-xl">
          {name}
        </h3>
        <p className="caption text-text-secondary">Size: {size}</p>
      ...
      <div className="flex items-center justify-between gap-4 sm:flex-col sm:items-end sm:justify-start">
        <div className="flex items-center gap-3 rounded-md border border-border bg-card p-1">
          ...
          <span className="font-data w-8 text-center text-base font-medium text-text-primary">
            {quantity}
          </span>
          <button
